      ...
      <div class="modal-content">
        ...
        <div class="modal-body d-flex flex-column align-items-center">
          <croppa
            ...
            placeholder="게시물에 등록할 사진을 선택해주세요"
          ...
          <div v-if="isSubmit" class="d-flex gap-3">
            <button class="btn-5 btn-grey" @click="croppa.remove()">삭제</button>
            <button class="btn-5 btn-yellow" @click="croppa.chooseFile()">다시 선택</button>
          </div>
          <button
